<?php
	...
	*/
	...
	define('__PC_CUSTOMER__', 'Demo SIMRS');
	//define('__PC_CUSTOMER_GROUP__', 'Pemerintahan Provinsi Riau');
	define('__PC_CUSTOMER_GROUP__', 'Demo SIMRS');
	...
	define('__PC_CUSTOMER_EMAIL__', 'customer@iconplus.id');
	...
	define('__PC_IDENT__', 'icon');
	//define('__SYSTEM_DOMAIN__', 'rsudpetalabumi.com');
	define('__SYSTEM_DOMAIN__', 'iconplus.com');
	//define('__APPS_NAME__', 'RSUDPTB::SIMRSv.2.0');
	define('__APPS_NAME__', 'ICON::SIMRSv.2.0');
	...
	/*
	 * master_unit_ruangan*/
	define('__KAMAR_IGD__', 'd0e8e876-a90e-4f0c-a5a5-8e9fdb298f8a');
	...
	define('__RECIPE_TIME_TOLERANCE__', 24);
