...
public final class ActivityLaporMatiBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final EditText laporJamMati;

  @NonNull
  public final EditText laporMatiKontakKeluarga;

  @NonNull
  public final EditText laporMatiNama;

  @NonNull
  public final EditText laporMatiNamaKeluarga;
  ...
  private ActivityLaporMatiBinding(@NonNull ConstraintLayout rootView,
      @NonNull LinearLayout btnBack, @NonNull Button btnLaporkanMati,
      @NonNull EditText laporJamMati, @NonNull EditText laporMatiKontakKeluarga,
      @NonNull EditText laporMatiNama, @NonNull EditText laporMatiNamaKeluarga,
    ...
    this.laporJamMati = laporJamMati;
    this.laporMatiKontakKeluarga = laporMatiKontakKeluarga;
    this.laporMatiNama = laporMatiNama;
    this.laporMatiNamaKeluarga = laporMatiNamaKeluarga;
  ...
  @NonNull
  public static ActivityLaporMatiBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityLaporMatiBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_lapor_mati, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityLaporMatiBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.lapor_jam_mati;
      EditText laporJamMati = ViewBindings.findChildViewById(rootView, id);
      if (laporJamMati == null) {
        break missingId;
      }

      id = R.id.lapor_mati_kontak_keluarga;
      EditText laporMatiKontakKeluarga = ViewBindings.findChildViewById(rootView, id);
      if (laporMatiKontakKeluarga == null) {
        break missingId;
      }
      ...
      id = R.id.lapor_mati_nama_keluarga;
      EditText laporMatiNamaKeluarga = ViewBindings.findChildViewById(rootView, id);
      if (laporMatiNamaKeluarga == null) {
        break missingId;
      }
      ...
      return new ActivityLaporMatiBinding((ConstraintLayout) rootView, btnBack, btnLaporkanMati,
          laporJamMati, laporMatiKontakKeluarga, laporMatiNama, laporMatiNamaKeluarga, laporMatiNik,
          laporMatiTanggalLahir, laporMatiTanggalMati, laporMatiTempatLahir, laporMatiTempatMati);
    }
