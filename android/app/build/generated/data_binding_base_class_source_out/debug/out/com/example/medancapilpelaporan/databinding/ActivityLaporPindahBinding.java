...
public final class ActivityLaporPindahBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityLaporPindahBinding(@NonNull ConstraintLayout rootView,
      @NonNull LinearLayout btnBack, @NonNull Button btnLaporkanMati,
      @NonNull EditText laporJamMati, @NonNull EditText laporMatiNama,
  ...
  @NonNull
  public static ActivityLaporPindahBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityLaporPindahBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_lapor_pindah, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityLaporPindahBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLaporPindahBinding((ConstraintLayout) rootView, btnBack, btnLaporkanMati,
          laporJamMati, laporMatiNama, laporMatiNik, laporMatiTanggalLahir, laporMatiTanggalMati,
          laporMatiTempatLahir, laporMatiTempatMati);
    }
